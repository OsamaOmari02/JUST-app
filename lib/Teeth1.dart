            ...
            body: Scrollbar(
              child: ListView(
                ...
                children: [
                  ...
                  provider.buildAutoSizeText("● أنواع تسوس الأسنان :", 18.00,Colors.red,FontWeight.bold),
                  ...
                  provider.buildAutoSizeText("● حسب مكان سطح السن :", 17.00,Colors.black,FontWeight.bold),
                  ...
                  provider.buildAutoSizeText("● حسب الأنسجة الصلبة المتضررة :", 17.00,Colors.black,FontWeight.bold),
                  provider.buildAutoSizeText(Teeth().s17, 17.00),
                  Image.asset('images/Teeth/19.jpg'),
                  provider.buildAutoSizeText("● حسب معدل التقدم :", 17.00,Colors.black,FontWeight.bold),
                  ...
                  provider.buildAutoSizeText("● مسببات تسوس الأسنان :", 18.50,Colors.red,FontWeight.bold),
