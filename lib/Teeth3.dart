            ...
            body: Scrollbar(
              child: ListView(
                ...
                children: [
                  ...
                  provider.buildAutoSizeText("● نصائح للمساعدة على الوقاية من تسوس الأسنان :", 18.00,Colors.lightGreen,FontWeight.bold),
                  ...
                  provider.buildAutoSizeText("● بعض النصائح للآباء للمحافظة على أسنان أطفالهم :", 18.00,Colors.lightGreen,FontWeight.bold),
                  provider.buildAutoSizeText("قبل الولادة :", 17.00,Colors.black,FontWeight.bold),
                  provider.buildAutoSizeText("- يجب على الاباء زيادة معرفتهما ووعيهما ب تسوس الأسنان ومخاطرة وكيفية الوقاية منه.", 17.00),
                  provider.buildAutoSizeText("عند الولادة :", 17.00,Colors.black,FontWeight.bold),
                  provider.buildAutoSizeText("- يجب ان تتعلم الأمهات الجدد كيفية تنظيف فم أطفالهم.", 17.00),
                  provider.buildAutoSizeText("أ- حديثي الولادة :", 18.00),
                  ...
                  provider.buildAutoSizeText("* عدم استخدام العسل مع اللهاي لزيادة تقبل الطفل لِ اللهاي.", 17.00),
                  provider.buildAutoSizeText("ب- في عمر 6 أشهر :", 18.00),
                  ...
                  provider.buildAutoSizeText("ج- بعد ١٢ شهراً :", 18.00),
                  ...
                  provider.buildAutoSizeText("● طرق العلاج :", 18.00,Colors.lightGreen,FontWeight.bold),
