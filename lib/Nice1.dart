            ...
            body: Scrollbar(
              child: ListView(
                ...
                children: [
                  ...
                  provider.buildAutoSizeText("● انواع التبييض : [8]", 18.00,Colors.green,FontWeight.bold),
                  ...
                  provider.buildAutoSizeText("● العوامل التي تؤثر في بياض الأسنان : [4]", 18.00,Colors.red,FontWeight.bold),
                  provider.buildAutoSizeText(Nice().s6, 17.00),
                  Padding(
                    padding: const EdgeInsets.all(25.0),
                    child: Image.asset('images/طب الاسنان التجميلي/4.png'),
                  ),
                  provider.buildAutoSizeText("● الاعراض الجانبية بعد تبييض الاسنان : [4]", 18.00,Colors.red,FontWeight.bold),
                  provider.buildAutoSizeText(Nice().s7, 17.00),
                  provider.buildAutoSizeText("● اضرار تبييض الاسنان : [4]", 18.00,Colors.red,FontWeight.bold),
