            ...
            body: Scrollbar(
              child: ListView(
                ...
                children: [
                  ...
                  provider.buildAutoSizeText("تعرف دواعم السن بأنها الأنسجة التي تحيط بالأسنان وتدعمها، وتشمل :", 17.00),
                  provider.buildAutoSizeText(Dis().s7, 17.00),
                  provider.buildAutoSizeText("● إلتهاب الأنسجة المحيطة/الداعمة :", 18.00,Colors.red,FontWeight.bold),
                  provider.buildAutoSizeText(Dis().s11, 17.00),
                  Image.asset('images/Dis/6.jpg'),
                  provider.buildAutoSizeText("● أسباب إلتهابات اللثة و الأنسجة المحيطة/الداعمة :", 18.00,Colors.lightGreen,FontWeight.bold),
                  provider.buildAutoSizeText("• البلاك / اللويحة الجرثومية :", 18.00),
                  ...
                  provider.buildAutoSizeText("● تقسم العوامل التي تزيد من حدة الأصابة بإلتهابات الأنسجة المحيطة/الداعمة :", 18.00,Colors.lightGreen,FontWeight.bold),
                  provider.buildAutoSizeText("1- عوامل موضعية :", 18.00),
                  ...
                  provider.buildAutoSizeText("- الأمراض الجهازية.", 18.00),
                  provider.buildAutoSizeText("- استخدام بعض الأدوية :", 18.00),
                  provider.buildAutoSizeText("يمكن للأدوية المستخدمة لعلاج الأمراض الجسدية أن تزيد من حدة التهاب اللثة منها :", 17.00),
                  provider.buildAutoSizeText(Dis().s19, 17.00),
                  provider.buildAutoSizeText("● إلتهابات الأنسجة المحيطة/الداعمة للأسنان :", 18.00,Colors.red,FontWeight.bold),
                  ...
                  provider.buildAutoSizeText("● أعراض التهابات الأنسجة المحيطة/الداعمة :", 18.00,Colors.red,FontWeight.bold),
