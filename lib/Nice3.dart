            ...
            body: Scrollbar(
              child: ListView(
                ...
                children: [
                  ...
                  provider.buildAutoSizeText("● عيوب كل منهما : [7,3]", 18.00, Colors.red,FontWeight.bold),
                  provider.buildAutoSizeText(Nice().s20, 17.00),
                  Image.asset('images/طب الاسنان التجميلي/9.png'),
                  provider.buildAutoSizeText("● القشور الخزفية ورائحة الفم : [3]", 18.00,Colors.red,FontWeight.bold),
                  ...
                  provider.buildAutoSizeText("● العناية بهما : [7,10]", 18.00,Colors.green,FontWeight.bold),
